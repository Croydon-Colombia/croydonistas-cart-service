...
public class GetItemDiscount {
    ...
    public static double getPercentDiscount(CustomersDto customer, ProductsDto product) {
        if (product.getCustomerDiscount() != null) {
            return product.getCustomerDiscount();
        }

        return customer != null && customer.getDiscount() != null ? customer.getDiscount() : 0;
    }
}
